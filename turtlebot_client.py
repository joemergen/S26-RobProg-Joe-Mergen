...
class TurtleClient(Node):
    def __init__(self):
        ...
        self.declare_parameter('turtleColor', 'green', ParameterDescriptor(description='Initial turtle color'))
        turtleColor = self.get_parameter('turtleColor').get_parameter_value().string_value
        self.turtle_display.color(turtleColor)
        self.declare_parameter('penSize', 3.0, ParameterDescriptor(description='Initial pen size'))
        penSize = self.get_parameter('penSize').get_parameter_value().double_value
